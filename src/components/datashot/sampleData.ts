...
export const metaAdProductStructure: MediaAdProductStructure = {
  fields: [
    ...
    },
    {
      ...
      required: false,
      options: ['올리브영', '네이버', '쿠팡', '29CM', '무신사', 'SSG', '컬리', 'G마켓']
    }
  ]
}
  ...
  fields: [
    {
      ...
      options: [
        ...
        '[보너스]시청데모 맥락형 타겟팅_논스킵_15초',
        '[아웃스트림] 홈메인',
        '(보너스)[T only] Prime Time_논스킵_15초',
        ...
        '시청데모 PKG_15초',
        '[통합] 베이직 인스트림_논스킵_30초',
        '[KBO대응]_Impression 보장PKG_15초',
        '[T only]시청데모 PKG_2549_스킵',
        '[T ONLY] 이미지배너_KBO',
        '(통합) 2025_KBO_DA_정규시즌_보너스',
        '[통합]CTVPremier_MF2539_논스킵_15초',
        'KBO_Impression 보장PKG_15초',
        '오늘의 티빙 TOP20_30초',
        '[통합]CTVPremier_MF2539_논스킵_15초_2',
        '[T ONLY] 시청데모_F2049_논스킵_15초',
        '(보너스)[통합] 베이직 인스트림_논스킵_15초',
        '[통합]TOP20_MF2554_논스킵_15초',
        'TSM_일반용(이닝사이, 투수교체, 프리뷰쇼 중CM용)_3049',
        'TW_TOP20_논스킵_15초',
        '[T ONLY] 시청데모_F3049_논스킵_15초',
        '[통합]베이직인스트림_MF2029_논스킵_15초_2',
        '[통합]베이직인스트림_Mnet채널타겟팅_논스킵_15초',
        '[T ONLY] WBC_풀커버리지 PKG_15초',
        '대부 프로모션마케팅 TOP20_30초',
