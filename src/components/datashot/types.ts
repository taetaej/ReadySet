...
export const targetingOptionsByMedia: { [media: string]: TargetingOption[] } = {
  ...
  'kakao모먼트': [
    ...
    {
      category: '성별x연령',
      options: ['남성 0~19', '남성 20~24', '남성 25~29', '남성 30~34', '남성 35~39', '남성 40~44', '남성 45~49', '남성 50~54', '남성 55~59', '남성 60~64', '남성 65~69', '남성 70~74', '남성 75~79', '남성 80 이상', '남성 나이 알 수 없음', '여성 0~19', '여성 20~24', '여성 25~29', '여성 30~34', '여성 35~39', '여성 40~44', '여성 45~49', '여성 50~54', '여성 55~59', '여성 60~64', '여성 65~69', '여성 70~74', '여성 75~79', '여성 80 이상', '여성 나이 알 수 없음', '성별 알 수 없음 0~19', '성별 알 수 없음 20~24', '성별 알 수 없음 25~29', '성별 알 수 없음 30~34', '성별 알 수 없음 35~39', '성별 알 수 없음 40~44', '성별 알 수 없음 45~49', '성별 알 수 없음 50~54', '성별 알 수 없음 55~59', '성별 알 수 없음 60~64', '성별 알 수 없음 65~69', '성별 알 수 없음 70~74', '성별 알 수 없음 75~79', '성별 알 수 없음 80 이상', '성별 알 수 없음 나이 알 수 없음']
    },
    {
      category: '지역',
  ...
  'TVING': [
    ...
    {
      category: '나이',
      options: ['0~19', '20~24', '25~29', '30~34', '35~39', '40~44', '45~49', '50~54', '55~59', '60~64', '65~69', '70~74', '75~79', '80 이상', '나이 알 수 없음']
    },
    {
      category: '성별x나이',
      options: ['남성 0~19', '남성 20~24', '남성 25~29', '남성 30~34', '남성 35~39', '남성 40~44', '남성 45~49', '남성 50~54', '남성 55~59', '남성 60~64', '남성 65~69', '남성 70~74', '남성 75~79', '남성 80 이상', '남성 나이 알 수 없음', '여성 0~19', '여성 20~24', '여성 25~29', '여성 30~34', '여성 35~39', '여성 40~44', '여성 45~49', '여성 50~54', '여성 55~59', '여성 60~64', '여성 65~69', '여성 70~74', '여성 75~79', '여성 80 이상', '여성 나이 알 수 없음', '성별 알 수 없음 0~19', '성별 알 수 없음 20~24', '성별 알 수 없음 25~29', '성별 알 수 없음 30~34', '성별 알 수 없음 35~39', '성별 알 수 없음 40~44', '성별 알 수 없음 45~49', '성별 알 수 없음 50~54', '성별 알 수 없음 55~59', '성별 알 수 없음 60~64', '성별 알 수 없음 65~69', '성별 알 수 없음 70~74', '성별 알 수 없음 75~79', '성별 알 수 없음 80 이상', '성별 알 수 없음 나이 알 수 없음']
    ...
    {
      category: '디바이스',
      options: ['ANDROID', 'CTV', 'IOS', 'MACOS', 'PC', 'VERSATILE']
    }
  ]
}
