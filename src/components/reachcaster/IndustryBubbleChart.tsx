...
const beautyData: BubbleDataPoint[] = [
  ...
  { name: 'kakao모먼트 > 카카오톡 비즈보드', spendShare: 6.8, ctr: 2.1, impression: 780000, color: 'hsl(var(--foreground))' },
  ...
  { name: 'kakao모먼트 > 카카오톡 채널 광고', spendShare: 4.5, ctr: 2.3, impression: 460000, color: 'hsl(var(--foreground))' },
  ...
  { name: 'kakao모먼트 > Daum 디스플레이', spendShare: 3.0, ctr: 2.4, impression: 410000, color: 'hsl(var(--foreground))' },
