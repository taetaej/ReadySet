...
export function ScenarioComparisonPanel({
  ...
  const availableScenarios: ComparisonScenario[] = [
    ...
    // 예산 비교용 — 조건 상이 (타겟 다름)
    { id: 'S014', name: '여성 20~29 타겟 (8억)', budget: 800000000, period: { start: '2024-10-01', end: '2024-12-31' }, targetGrp: ['여성 20~24세', '여성 25~29세'] },
    { id: 'S015', name: '전체 타겟 (12억)', budget: 1200000000, period: { start: '2024-10-01', end: '2024-12-31' }, targetGrp: ['전체'] },
    // 예산 비교용 — 조건 상이 (기간 다름)
    { id: 'S016', name: '1분기 예산안 (9억)', budget: 900000000, period: { start: '2025-01-01', end: '2025-03-31' }, targetGrp: ['남성 25~29세', '남성 30~34세'] },
    // 예산 비교용 — 조건 상이 (타겟+기간 다름)
    { id: 'S017', name: '여성 30~39 1분기 (11억)', budget: 1100000000, period: { start: '2025-01-01', end: '2025-03-31' }, targetGrp: ['여성 30~34세', '여성 35~39세'] },
    // 기간 비교용 시나리오 (동일 예산/타겟, 다른 기간)
    { id: 'S018', name: '1월 단기 집행 (1개월)', budget: 1000000000, period: { start: '2025-01-01', end: '2025-01-31' }, targetGrp: ['남성 25~29세', '남성 30~34세'] },
    { id: 'S019', name: '1분기 집행 (3개월)', budget: 1000000000, period: { start: '2025-01-01', end: '2025-03-31' }, targetGrp: ['남성 25~29세', '남성 30~34세'] },
    { id: 'S020', name: '상반기 집행 (6개월)', budget: 1000000000, period: { start: '2025-01-01', end: '2025-06-30' }, targetGrp: ['남성 25~29세', '남성 30~34세'] },
    // 기간 비교용 — 조건 상이 (예산 다름)
    { id: 'S021', name: '2개월 집행 (예산 상이)', budget: 800000000, period: { start: '2024-11-01', end: '2024-12-31' }, targetGrp: ['남성 25~29세', '남성 30~34세'] },
    // 기간 비교용 — 조건 상이 (타겟 다름)
    { id: 'S022', name: '상반기 여성 타겟', budget: 1000000000, period: { start: '2025-01-01', end: '2025-06-30' }, targetGrp: ['여성 25~29세', '여성 30~34세'] }
  ]
