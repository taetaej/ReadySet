...
브라우저 캐시를 삭제하고 다시 시도해주세요. 문제가 지속되면 관리자에게 문의하세요.
...
각 솔루션(DataShot, Reach Caster, SpinX)의 핵심 기능과 활용 사례를 정리한 1-pager입니다.

### 온보딩 가이드

신규 사용자를 위한 단계별 시작 가이드입니다. 계정 설정부터 첫 시나리오 생성까지의 과정을 안내합니다.

## 다운로드 방법

각 자료의 다운로드 링크는 준비 중입니다. 필요 시 담당자에게 문의하세요.`
    }
  ]
}
