...
#### 5.1.2 Meta 협력 광고 파트너사 옵션

Meta 매체 선택 시 광고상품 필드 중 '협력 광고 파트너사' 필드가 추가 제공됩니다.

| 요소 | 스펙 |
|---|---|
| 필드명 | 협력 광고 파트너사 |
| 키 | collaborativePartner |
| 필수 여부 | 선택 (미선택 허용) |
| 선택 방식 | 다중 선택 (체크박스) |
| 옵션 목록 | 올리브영, 네이버, 쿠팡, 29CM, 무신사, SSG, 컬리, G마켓 |

- 첫 번째 필드(캠페인 목표) 선택 후 활성화
- 미선택 시에도 Step 2 완료 조건에 영향 없음
...
Meta 매체 선택 시 아래 그룹으로 지표가 분류됩니다.

| 그룹명 | 설명 |
|---|---|
| 성과 | 광고비, 노출수, 클릭수, CPC, CPM, CTR 등 기본 효율 지표 |
| 참여 | 게시물 반응, 게시물 참여, 링크 클릭 등 |
| 전환 | 구매, 등록 완료, 앱 설치 등 |
| 협력 광고 | 협력 광고(Collaborative Ads) 전용 지표 |

##### 협력 광고 지표 목록

| 지표 ID | 라벨 |
|---|---|
| collab_web_purchase | 공유 항목이 포함된 웹사이트 구매 |
| collab_app_purchase | 공유 항목이 포함된 앱 내 구매 |
| collab_web_purchase_value | 공유 항목의 웹사이트 구매 전환값 |
| collab_app_purchase_roas | 공유 항목의 앱 내 구매 전환값만 |
| collab_web_add_to_cart | 공유 항목이 포함된 웹사이트 장바구니에 담기 |
| collab_app_add_to_cart | 공유 항목이 포함된 앱 내 장바구니에 담기 |
| collab_web_cart_value | 공유 항목의 웹사이트 장바구니에 담기 전환값 |
| collab_app_cart_roas | 공유 항목의 앱 내 장바구니에 담기 전환값만 |

- 타겟팅 카테고리 = '기기유형' 선택 시 협력 광고 그룹 전체 제외
...
- Meta 매체: 캠페인 목표, 구매 유형, 플랫폼, 성과 목표, 협력 광고 파트너사 (5컬럼)
- 기타 매체: 캠페인 유형 (1컬럼)
...
| 27 | Meta 협력 광고 파트너사 옵션 표시 | Meta 선택 시 '협력 광고 파트너사' 필드 노출, 다중 선택 가능 |
| 28 | Meta 협력 광고 지표 그룹 표시 | Meta 선택 시 지표 목록에 '협력 광고' 그룹 8개 지표 노출 |
| 29 | Meta 기기유형 타겟팅 시 협력 광고 지표 제외 | 타겟팅 '기기유형' 선택 시 협력 광고 그룹 전체 미노출 |
